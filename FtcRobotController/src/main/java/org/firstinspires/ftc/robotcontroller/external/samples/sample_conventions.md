...
Sensor:    	This is a Sample OpMode that shows how to use a specific sensor.
            It is not intended to drive a functioning glyphRobot, it is simply showing the minimal code
            required to read and display the sensor values.

Hardware:	This is not an actual OpMode, but a helper class that is used to describe
            one particular glyphRobot's hardware configuration:   eg: For the K9 or Pushbot.
...
Pushbot:	This is a Sample OpMode that uses the Pushbot glyphRobot hardware as a base.
...
Special programming methods, or glyphRobot control techniques should be reserved for “Concept” Samples,
